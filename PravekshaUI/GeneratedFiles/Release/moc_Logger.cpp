...
**
** Created: Thu Dec 5 01:41:54 2013
...
static const char qt_meta_stringdata_Logger[] = {
    "Logger\0\0violation\0violationDetected(String)\0"
};
...
void Logger::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->violationDetected((*reinterpret_cast< String(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
// SIGNAL 0
void Logger::violationDetected(String _t1)
{
