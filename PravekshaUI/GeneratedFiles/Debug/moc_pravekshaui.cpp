...
static const char qt_meta_stringdata_PravekshaUI[] = {
    ...
    "on_btnBrowse_clicked()\0index\0"
    "onListItemClicked(QModelIndex)\0speed\0"
    "updateLogList(double)\0"
};
...
void PravekshaUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->onListItemClicked((*reinterpret_cast< const QModelIndex(*)>(_a[1]))); break;
        case 4: _t->updateLogList((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
    }
}
