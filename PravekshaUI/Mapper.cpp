...
VehicleDataStruct Mapper::transform1(vector<vector<int>> &blobs, VehicleDataStruct &vehicleData , Mat &frame,vector<Point> oriCorners, vector<double> dist){
	...
	line(t,Point(leftCenterLine,topLine), Point(leftCenterLine,bottomLine), Scalar(255,255,255), 2, 4,0);
	line(t,Point(centerLine,topLine), Point(centerLine,bottomLine), Scalar(255,255,255), 4, 4,0);
	line(t,Point(rightCenterLine,topLine), Point(rightCenterLine,bottomLine), Scalar(255,255,255), 2, 4,0);

	line(t,Point(leftLine,realMappingStart),Point(rightLine,realMappingStart), Scalar(255,255,255), 2, 4,0);
	line(t,Point(leftLine,realMappingEnd),Point(rightLine,realMappingEnd), Scalar(255,255,255), 2, 4,0);
